...
public:
    ...
    const uint16_t smatrix[121] = {
        ...
        44,  43,  42,  41,  40,  63,  62,  61,  60,  59,  58,  57,  56,  55,
        54,  53,  76,  75,  74,  73,  72,  71,  70,  69,  68,  67,  66,  89,
        88,  87,  86,  85,  84,  83,  82,  81,  80,  79,  102, 101, 100, 99,
        98,  97,  96,  95,  94,  93,  92,  115, 114, 113, 112, 111, 110, 109,
        108, 107, 106, 105, 128, 127, 126, 125, 124, 123, 122, 121, 120, 119,
        118, 141, 140, 139, 138, 137, 136, 135, 134, 133, 132, 131, 154, 153,
    ...
    virtual inline const uint16_t NUM_PIXELS() override { return 169; };

    //------------------------------------------------------------------------------

    virtual inline const uint16_t NUM_SMATRIX() override { return 121; };
    ...
    virtual inline const uint16_t NUM_RMATRIX() override { return 48; };
