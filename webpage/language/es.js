let TRANSLATION_ES = {
	...
	"functions": {
		...
		"settings": {
			...
			"save": "Ahorrar",
			"speed": "Velocidad ",
			"fire-cooling": "Enfriamiento ",
			"fire-sparking": "Chispas ",
			"leds": "Número de LEDs ",
			"position": "Posición "
		}
	},
	...
	"view": {
		...
		"front": {
			...
			"de-11-11": "🇩🇪 11 × 11",
			"de-11-11-schwaebisch": "🇩🇪 11 × 11 Estilo suabo",
	...
	"settings": {
		...
		"hardware-pins": {
			...
			"i2c-sda": "I2C SDA",
			"i2c-scl": "I2C SCL",
			"i2c-scan": "Buscar direcciones I2C",
			"i2c-result": "Escaneo I2C",
			"i2c-scanning": "Buscando direcciones I2C...",
			"i2c-found": "Encontrado:",
			"i2c-none": "No se encontraron direcciones I2C.",
			"i2c-disabled": "I2C está desactivado.",
			"i2c-invalid": "Pines I2C no válidos.",
			"i2c-pair": "SDA y SCL deben estar configurados o desactivados juntos.",
