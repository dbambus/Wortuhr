let TRANSLATION_EN_US = {
	...
	"view": {
		...
		"front": {
			...
			"de-11-11": "🇩🇪 11 × 11",
			"de-11-11-schwaebisch": "🇩🇪 11 × 11 Swabian Style",
			...
			"ch-10-11-zh": "🇨🇭 10 x 11 Zurich German",
	...
	"settings": {
		...
		"hardware-pins": {
			...
			"i2c-sda": "I2C SDA",
			"i2c-scl": "I2C SCL",
			"i2c-scan": "Scan I2C addresses",
			"i2c-result": "I2C scan",
			"i2c-scanning": "Scanning I2C addresses...",
			"i2c-found": "Found:",
			"i2c-none": "No I2C addresses found.",
			"i2c-disabled": "I2C is disabled.",
			"i2c-invalid": "Invalid I2C pins.",
			"i2c-pair": "SDA and SCL must both be set or both be disabled.",
